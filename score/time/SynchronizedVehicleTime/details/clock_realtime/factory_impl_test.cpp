...
TEST_F(TestFactoryImpl, ObtainSynchronizedSlaveTimebase)
{
    ...
    // Then the returned object must be of type `score::time::details::clock_realtime::ClockProvider`
    ASSERT_NE(dynamic_cast<details::clock_realtime::ClockProvider*>(factory.ObtainSynchronizedSlaveTimebase().get()),
              nullptr)
        << "Obtained object from SynchronizedVehicleTime::FactoryImpl is not of type "
           "score::time::details::clock_realtime::ClockProvider!";
}
